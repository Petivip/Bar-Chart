function chart(dataset) {
  ...
  var minGdp = d3.min(dataset, function (item) {return item[1];});
  var maxGdp = d3.max(dataset, function (item) {return item[1];});
  ...
  attr("height", function (d, i) {return h - yScale(d[1]);}).
